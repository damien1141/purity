...
awful.screen.connect_for_each_screen(function(s)
    ...
    local power_profiles = require("layout.controlCenter.power_profiles")
    ...
    cc_toggle = function(screen)
		...
		awful.placement.top_right(control_c, {honor_workarea = true, margins = beautiful.useless_gap * 2})
