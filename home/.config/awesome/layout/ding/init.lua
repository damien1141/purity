...
naughty.config.defaults.title       = "叮！"
naughty.config.defaults.position    = "bottom_right"
naughty.config.defaults.y           = dpi(200)  -- offset to lower notifications below bar-min
...
naughty.connect_signal("request::display", function(n)
    ...
    if n._private and n._private._game_notification then return end
    ...
    local time_n = wibox.widget{
        {
            markup      = helpers.colorize_text("现在", beautiful.fg_color .. "BF"),
            font        = beautiful.font_var .. " 10",
            align       = "right",
            valign      = "center",
            widget      = wibox.widget.textbox
    ...
    local close = wibox.widget {
        markup      = helpers.colorize_text("x", beautiful.red_color),
	...
	local timeout_bar = wibox.widget({
		...
		min_value = 0,
		value = 0,
		background_color = beautiful.bg_frost_3,
