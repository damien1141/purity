...
local args = {
    terminal = "alacritty",
    favorites = { "librewolf", "betterbird", "tube", "kitty", "thunar file manager", "stremio", "steam", "heroic games launcher", "lutris", "prism", "gram", "obsidian" },
    ...
    save_history = true,
    background = beautiful.bg_transparent,
    shape = helpers.rrect(beautiful.rounded_square),
    prompt_height = dpi(60),
    placement = awful.placement.centered,
    prompt_margins = dpi(20),
    prompt_paddings = dpi(20),
    prompt_text = "> ",
    prompt_color = beautiful.bg_frost_2,
    ...
    app_selected_color = beautiful.accent_transparent,
    app_normal_color = beautiful.bg_frost_3,
    app_normal_hover_color = beautiful.bg_frost_2,
    app_selected_hover_color = beautiful.accent_transparent,
    ...
    icon_size = 35,
    apps_spacing = dpi(15),
    app_shape = helpers.rrect(beautiful.rounded_square)
}
