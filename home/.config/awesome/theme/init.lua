...
-- backgrounds (Frosted - alpha channels trigger picom blur)
theme.bg_transparent   = colors.bg_transparent
theme.bg_frost_2       = colors.bg_frost_2
theme.bg_frost_3       = colors.bg_frost_3

-- accent (Frosted)
theme.accent_transparent = colors.accent_transparent
...
-- Bling playerctl
-- ~~~~~~~~~~~~~~~
--theme.playerctl_ignore                      = {"chromium", "brave"}
...
-- Safety net: some Awesome builds ignore table-based init and leave
