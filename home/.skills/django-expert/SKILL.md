---
name: django-expert
description: "Build Django apps and DRF REST APIs. Use with settings.py, models.py, manage.py, or any Django project file: creates model indexes, optimizes ORM queries (select_related/prefetch_related), builds serializers and viewsets, and configures JWT auth. Trigger terms: Django, DRF, Django REST Framework, Django ORM, serializer, viewset, Python web."
license: MIT
metadata:
