...
description: Deploys and manages Kubernetes workloads. Use for deployment manifests, pod security, service accounts, network policies, debugging pod crashes, right-sizing, Helm, RBAC, and GitOps.
license: MIT
metadata:
