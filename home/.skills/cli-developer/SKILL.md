---
name: cli-developer
description: Builds CLI tools with argument parsing, subcommands, progress bars, and shell completions. Use when building CLIs or adding prompts, flags, or completions (commander, click, typer, cobra).
license: MIT
metadata:
