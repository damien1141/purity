---
name: fastapi-expert
description: "Builds high-performance async Python APIs with FastAPI and Pydantic V2. Use to create REST endpoints, define models, implement auth flows, set up async SQLAlchemy, add JWT, build WebSocket endpoints, or generate OpenAPI. Trigger terms: FastAPI, Pydantic, async Python, Python API, REST API Python, SQLAlchemy async, JWT authentication, OpenAPI, Swagger Python."
license: MIT
metadata:
