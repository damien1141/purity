...
description: Uses persistent markdown files for planning, progress tracking, and knowledge storage. Use for complex tasks, multi-step projects, research, or when the user mentions planning, organizing work, or wants structured output.
---
