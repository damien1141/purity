---
name: sql-pro
description: Optimizes SQL, designs schemas, and fixes performance. Use for slow queries, complex joins/aggregates, window functions, CTEs, indexing, query plans, EXPLAIN/ANALYZE, recursive queries, and cross-dialect migration (PostgreSQL, MySQL, SQL Server, Oracle).
license: MIT
metadata:
