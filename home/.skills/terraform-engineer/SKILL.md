...
description: Implements infrastructure as code with Terraform across AWS, Azure, GCP. Covers modules, state management, provider config, multi-environment workflows, and infrastructure testing.
license: MIT
metadata:
