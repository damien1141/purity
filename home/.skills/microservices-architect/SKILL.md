...
description: "Designs distributed systems: decomposes monoliths into bounded-context services, recommends communication patterns, and produces service-boundary diagrams + resilience strategies. Covers DDD, saga, event sourcing, CQRS, service mesh, and distributed tracing."
license: MIT
metadata:
