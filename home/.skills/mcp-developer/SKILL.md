---
name: mcp-developer
description: Builds, debugs, and extends MCP servers/clients connecting AI systems to external tools and data. Use for tool handlers, resource providers, stdio/HTTP/SSE transport, Zod/Pydantic schema validation, and debugging protocol compliance.
license: MIT
metadata:
