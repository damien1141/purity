...
description: "Plans incremental migrations: identifies service boundaries, produces dependency maps and roadmaps, and generates API facades for aging codebases. Use for strangler-fig or branch-by-abstraction, decomposing monoliths, and reducing technical debt."
license: MIT
metadata:
