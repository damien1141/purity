---
name: code-reviewer
description: Reviews code and diffs for bugs, security issues (SQL injection, XSS, insecure deserialization), code smells, N+1 queries, and architecture concerns, then produces a prioritized report. Use for PR reviews, quality audits, and refactoring. Broad-scope; defers to security-reviewer and test-master for specialized depth.
license: MIT
