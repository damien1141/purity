...
description: Optimizes queries and performance on PostgreSQL and MySQL. Use for slow queries, execution plans, index design, query rewrites, config tuning, partitioning, and lock contention.
license: MIT
metadata:
