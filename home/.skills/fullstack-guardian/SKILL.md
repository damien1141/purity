...
description: Builds security-focused full-stack apps with layered security across the whole stack. Use when implementing features spanning frontend + backend, building REST APIs with UI, wiring components to endpoints, or adding CRUD forms -- covering Frontend, Backend, and Security in one workflow.
license: MIT
metadata:
