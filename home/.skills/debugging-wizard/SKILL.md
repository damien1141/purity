...
description: Traces errors through stack traces and logs to isolate root causes with a hypothesis-driven method. Use for crashes, unexpected behavior, and log analysis.
license: MIT
metadata:
