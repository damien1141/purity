...
description: "Fine-tunes LLMs and adapts foundation models. Use for LoRA/QLoRA adapters, JSONL dataset prep, hyperparameters, PEFT, transfer learning, RLHF, DPO, and quantizing/deploying fine-tuned models. Trigger terms: LoRA, QLoRA, PEFT, finetuning, adapter tuning, LLM training, model training, custom model."
license: MIT
metadata:
