---
name: sre-engineer
description: Defines SLIs/SLOs, error-budget policies, incident response, and capacity models, and produces monitoring config + automation. Use for reliability at scale, incident management, chaos engineering, toil reduction, and capacity planning.
license: MIT
metadata:
