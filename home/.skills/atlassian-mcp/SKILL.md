---
name: atlassian-mcp
description: Manages Jira and Confluence via MCP. Use when querying Jira with JQL, creating or updating tickets, searching or editing Confluence with CQL, managing sprints/backlogs, or setting up Atlassian MCP auth.
license: MIT
metadata:
