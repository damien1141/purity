...
description: Writes, refactors, and evaluates prompts for LLMs -- optimized templates, structured output schemas, evaluation rubrics, and test suites. Use for new prompts, improving accuracy/token efficiency, chain-of-thought/few-shot, system prompts with guardrails, and function-calling schemas.
license: MIT
metadata:
