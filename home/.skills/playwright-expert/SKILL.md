...
description: "Writes E2E tests with Playwright and sets up test infrastructure. Use for test scripts, page objects, fixtures, reporters, CI integration, API mocking, visual regression. Trigger terms: Playwright, E2E test, browser testing, automation, Page Object Model, test flakiness."
license: MIT
metadata:
