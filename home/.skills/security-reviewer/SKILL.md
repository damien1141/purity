...
description: Identifies security vulnerabilities and produces audit reports with severity ratings and remediation guidance. Use for security audits, code reviews, infrastructure security, SAST, pentesting, DevSecOps, cloud reviews, dependency/secrets scanning, and compliance.
license: MIT
