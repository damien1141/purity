...
description: Designs cloud architectures and migration plans across AWS, Azure, and GCP. Covers Well-Architected Framework, cost optimization, disaster recovery, landing zones, security, and serverless design.
license: MIT
metadata:
