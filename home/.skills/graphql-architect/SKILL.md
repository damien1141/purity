...
description: Designs GraphQL schemas, Apollo Federation, and real-time subscriptions. Covers schema design, resolvers with DataLoader, query optimization, and federation directives.
license: MIT
metadata:
