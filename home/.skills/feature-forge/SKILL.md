---
name: feature-forge
description: Runs requirements workshops to produce specs, user stories, EARS-format functional requirements, acceptance criteria, and implementation checklists. Use for defining features, gathering requirements, and writing specs/PRDs.
license: MIT
metadata:
