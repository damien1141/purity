---
name: javascript-pro
description: Writes, debugs, and refactors JavaScript using modern ES2023+, async/await, ESM, and Node.js APIs. Use for vanilla JS apps, Promise-based async flows, browser/Node performance, Web Workers, Fetch API, or reviewing .js/.mjs/.cjs files.
license: MIT
metadata:
