---
name: chaos-engineer
description: Designs chaos experiments, failure-injection frameworks, and game-day exercises for distributed systems -- producing runbooks, manifests, rollback procedures, and post-mortems. Use for resilience testing, blast-radius control, and fault injection (Chaos Monkey, Litmus Chaos).
license: MIT
metadata:
