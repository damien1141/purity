---
name: test-master
description: Generates tests, mocking strategies, coverage analysis, test architectures, and defect reports across functional, performance, and security testing. Use for unit/integration/E2E tests, test strategy, k6/Artillery load testing, OWASP, and flaky-test debugging.
license: MIT
metadata:
