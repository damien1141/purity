...
description: React useEffect/useState best practices from official docs. Use when writing or reviewing effects, derived values, data fetching, or state synchronization. Teaches when NOT to use Effects and better alternatives.
---
