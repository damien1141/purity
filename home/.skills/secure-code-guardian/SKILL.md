...
description: Secures user input and implements auth/authorization plus OWASP Top 10 prevention -- bcrypt/argon2 hashing, parameterized SQL, CORS/CSP, Zod validation, JWT tokens. Use for auth, input validation, encryption, session management, and hardening. For pre-built OAuth/SSO or standalone audits, prefer a specialized skill.
license: MIT
metadata:
