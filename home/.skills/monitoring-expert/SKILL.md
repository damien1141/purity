...
description: "Sets up monitoring and observability: Prometheus/Grafana dashboards, structured logging, alerting rules, distributed tracing, load testing (k6/Artillery), profiling, and capacity planning."
license: MIT
metadata:
