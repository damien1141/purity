---
name: hono
description: Builds Hono web apps. Use when building Hono, asking about Hono APIs/routing/middleware/JSX/validation/testing/streaming, or when code imports 'hono' or user mentions Hono. Test endpoints with `npx hono request`.
---
