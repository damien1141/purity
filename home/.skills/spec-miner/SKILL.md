---
name: spec-miner
description: "Reverse-engineers systems to extract specifications from existing codebases. Use for legacy/undocumented systems, inherited projects, or old codebases. Maps code dependencies, generates API docs from source, surfaces undocumented logic, and explains what code does. Trigger: reverse engineer, old codebase, no docs, figure out how this works, inherited project, code archaeology."
license: MIT
