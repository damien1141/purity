...
description: Generates, formats, and validates technical documentation -- docstrings, JSDoc, OpenAPI/Swagger specs, doc portals, and user guides. Use when adding docstrings, building API docs, or writing tutorials.
license: MIT
metadata:
