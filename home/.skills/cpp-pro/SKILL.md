---
name: cpp-pro
description: "Writes, optimizes, and debugs modern C++ (C++20/23): concepts, ranges, coroutines, SIMD, template metaprogramming, and memory management. Use for performance bottlenecks, concurrency, and CMake build config."
license: MIT
metadata:
