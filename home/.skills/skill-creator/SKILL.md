---
name: skill-creator
description: Create or improve skills. Use for new skills, updating existing ones, or guidance on when something should be a skill versus MCP, hooks, tools, or a plugin scaffold.
metadata:
