---
name: the-fool
description: Challenges ideas, plans, decisions, and proposals with structured critical reasoning. Use to play devil's advocate, run a pre-mortem, red team, or audit evidence and assumptions.
license: MIT
metadata:
