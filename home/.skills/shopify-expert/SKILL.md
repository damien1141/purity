---
name: shopify-expert
description: "Builds and debugs Shopify themes (.liquid, theme.json, sections), custom apps (shopify.app.toml, OAuth, webhooks), and Storefront API headless storefronts. Use for Liquid templating, Hydrogen/React storefronts, checkout extensions, Shopify Functions, and performance. Trigger: Liquid, Storefront API, App development, Shopify CLI, App Bridge, Polaris."
license: MIT
metadata:
